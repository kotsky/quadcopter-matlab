...
ylabel('Distance (m)');
subplot(1,3,2);
plot(Quad.t_plot,Quad.Y_plot*(-1))
title('Y Position');
xlabel('Time (s)');
ylabel('Distance (m)');
subplot(1,3,3);
plot(Quad.t_plot,Quad.Z_plot+Quad.Correction_axe_Z)
title('Z Position');
xlabel('Time (s)');
ylabel('Distance (m)');
end
...
ylabel('Distance (m)');
subplot(1,3,2);
plot(Quad.t_plot,Quad.Z_ref_plot+Quad.Correction_axe_Z)
